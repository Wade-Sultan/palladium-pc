...
config :admin, AdminWeb.Endpoint,
  ...
  live_view: [signing_salt: "gG4vwUqj"]
...
config :backpex,
  translator_function: {AdminWeb.CoreComponents, :translate_backpex},
  error_translator_function: {AdminWeb.CoreComponents, :translate_error}
